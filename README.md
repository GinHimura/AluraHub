...
Este projeto é um aplicativo desenvolvido em React Native que utiliza uma API para visualizar o perfil de uma pessoa e listar seus projetos. O aplicativo permite adicionar, alterar ou remover projetos. Durante o desenvolvimento deste projeto, aprendi sobre as operações de CRUD em uma aplicação web.

## Funcionalidades

- Visualizar perfil de usuário
- Exibir informações básicas do usuário, como nome, e-mail e número de seguidores
- Visualizar lista de projetos do usuário
